...
contextBridge.exposeInMainWorld('desktopApp', {
  ...
  getAccessStatus: () => ipcRenderer.invoke('access:get-status'),
  migrateLocalToAccess: () => ipcRenderer.invoke('access:migrate-local'),
  activateExistingAccess: () => ipcRenderer.invoke('access:activate-existing'),
  disableAccessDatabase: (options) => ipcRenderer.invoke('access:disable', options),
  syncAccessState: (state) => ipcRenderer.invoke('access:sync-state', state),
