  ...
  return <section className="page">
    ...
    <div className="settings-card updater-card">
      <div className="updater-head">
        ...
        <span className="update-version-pill">V{updateStatus?.currentVersion||'4.1.0'}</span>
      </div>
