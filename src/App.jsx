...
function App() {
  ...
  const [updateStatus,setUpdateStatus] = useState({currentVersion:'4.2.0',source:{owner:'Yahiaza',repo:'Finance---Loan',autoCheck:true},configured:true,checked:false,progress:0,downloading:false,downloadedPath:''});
